...
//static  uchar rcvbuf[50];
//static  uchar sendbuf[50];
...
//#ifdef CONFIG_SYS_ALLOC_DPRAM
        dpaddr = m8260_cpm_dpalloc ((sizeof(cbd_t)*2 + 2), 16);
//#else
//        dpaddr = CPM_SPI_BASE;
//#endif
	...
	rbdf = (cbd_t *)&immr->im_dprambase[dpaddr];
...
int spi_write_test (uchar testdata)
{
        ...
        //memset(txbuf, 1, 1);
        * (volatile uchar *)(tbdf->cbd_bufaddr)  = testdata;		/* write enable		*/
        ...
        //	printf("*** spi_write: Time out while writing!\n");
        //}
        ch = * (volatile uchar *)rbdf->cbd_bufaddr;
