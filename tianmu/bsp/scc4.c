...
#define SCC_INDEX4		3
#define CMXSCR_MASK4		(CMXSCR_GR4|CMXSCR_SC4|\
					CMXSCR_RS4CS_MSK|CMXSCR_TS4CS_MSK)
#define CMXSCR_VALUE4		(CMXSCR_RS4CS_BRG4|CMXSCR_TS4CS_BRG4)

	void
scc4_serial_setbrg (void)
{
	gd_t * gd=ptr_gd;

	m8260_cpm_setbrg(SCC_INDEX4, gd->baudrate);
}


int scc4_serial_init (void)
{
	...
	sp = (scc_t *) &(im->im_scc[SCC_INDEX4]);
	up = (scc_uart_t *)&im->im_dprambase[PROFF_SCC4];
	...
	*/
	 ...
	 */
	im->im_cpmux.cmx_scr = (im->im_cpmux.cmx_scr&~CMXSCR_MASK4)|CMXSCR_VALUE4;
	...
	*/
	...
	cp->cp_cpcr = mk_cr_cmd(CPM_CR_SCC4_PAGE, CPM_CR_SCC4_SBLOCK,
