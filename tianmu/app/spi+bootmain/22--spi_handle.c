...
void Spi_Main (void * ppdata) {
        ...
        INT8U spircv[50] ;
        INT8U spisend[50];
        INT8U spisend1[24]= {0xeb, 0x90, 0x03,0x04,0x08,0x09,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x55,0x66,0x66,0x66,0x66,0x66,0x66,0x66,0x66,0x77,0x77};
        INT8U spibuf[24];
        INT32U k,i,n,cpu_sr;
        INT8U  * spi, err;
        INT32U addr, len;
        INT8U dest;
// shao  zhan   shuai  daima 
       printf ("SPI_MAIN\n");
        for (;;) {
#if 1
                printf ("**********************************************************************\n");
                printf ("**********************************************************************\n");
#endif
                spi = (INT8U *)OSQPend(StarSQ , 0, &err);
                len = * (spi + 8);
