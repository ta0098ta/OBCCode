...
/* HDLC controller through FCC. add by HHTECH
*/
typedef struct fcc_hdlc {
	fccp_t	hdlc_genfcc;
	u_char    reserved1[8]; /* Reserved area */
	uint     c_mask;       /* CRC constant */
	...
	uint     max_cnt;      /* maximum length counter */
