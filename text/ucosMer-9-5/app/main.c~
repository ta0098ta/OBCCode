...
extern void hdlc_send_2(void *jdata);
...
extern void MEMSGyro_Main(void *jdata);
extern void BDGPS_Main(void *jdata);
extern void gps_serial_scc3(void);
...
void main (void)
{
        ...
        *(volatile INT32U *)(0xF0010D00) |= 0x00001000;	//PDIR_PA19
        ...
        OSTaskCreate(MEMSGyro_Main,(void *)0, &Task14[TASK_STK_SIZE-1],25);
        OSTaskCreate(BDGPS_Main, (void *)0, &Task15[TASK_STK_SIZE-1],26); 
        OSTaskCreate(ProgramControlUart,(void *)0,&Task3[TASK_STK_SIZE - 1],28);         
        OSTaskCreate(gps_serial_scc3,(void *)0, &Task16[TASK_STK_SIZE - 1],32);
        ...
        OSTaskCreate(StarSensorTask,(void *)0, &Task11[TASK_STK_SIZE - 1],38);        
